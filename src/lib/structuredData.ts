...
const ORGANIZATION = {
  ...
  // География присутствия: два собственных офиса и два города, где работают
  // официальные дилеры. Для поиска это сигнал, что компания обслуживает регион,
  // а не только Астану.
  areaServed: [
    { "@type": "Country", name: "Казахстан" },
    { "@type": "City", name: "Астана" },
    { "@type": "City", name: "Алматы" },
    { "@type": "City", name: "Жезказган" },
