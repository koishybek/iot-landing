...
const STATIC_PAGES: Record<string, { title: string; description: string }> = {
  ...
  "/catalog": {
    title: `Каталог счётчиков воды, тепла и газа — купить в ${CITY_IN}`,
    description: `Счётчики ${BRAND} (${BRAND_CYRILLIC}), YOMTEY и Pulsar с импульсным выходом, LoRaWAN и NB-IoT. Подбор по диаметру и протоколу, поставка по Казахстану.`,
  },
  "/solutions": {
  ...
  "/contacts": {
    ...
    description:
      "Адрес, телефон и почта IoT-Exponenta в Астане: г. Астана, ул. Петрова, 18/1. Консультация по подбору приборов учёта и расчёт стоимости.",
  },
};
