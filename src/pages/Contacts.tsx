...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Техническая поддержка доступна круглосуточно по телефону +7 771 173 1722 или через WhatsApp. Также можно написать на info@iot-exp.kz — среднее время ответа 30 минут.",
  },
];
