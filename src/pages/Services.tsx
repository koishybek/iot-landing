...
const services = [
  {
    ...
    desc: "Профессиональный монтаж систем электроснабжения, воды, тепла и газа под ключ.",
        ...
        <div className="container-main relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-[#5C7A6B] leading-relaxed max-w-2xl">
              ...
              приборов учета электроэнергии, воды, тепла и газа. Работаем под ключ — от проекта
