...
async function main() {
  ...
  const llms = [
    ...
    "",
    "Головной офис: г. Астана, ул. Алексея Петрова 18/1, +7 771 173 1722.",
    "Офис в Алматы: просп. Назарбаева 50, офис 412, +7 707 313 40 50, +7 702 291 20 78.",
    "",
    "Официальные дилеры:",
    "- Жезказган — ИП «Сеник Константин Александрович», ул. М. Жалиля 19, офис 8, +7 705 121 54 63.",
    "- Актау — ТОО «САМД КАЗ» (SAMD KAZ), мкр. 4А, здание 39, офис 210, +7 701 742 86 92, +7 777 204 27 27.",
    "",
